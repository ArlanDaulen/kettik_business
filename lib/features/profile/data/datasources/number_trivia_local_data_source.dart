...
const CACHED_NUMBER_TRIVIA = 'CHACHED_NUMBER_TRIVIA';

class NumberTriviaLocalDataSourceImplemetation
    extends NumberTriviaLocalDataSource {
  final SharedPreferences sharedPreferences;

  NumberTriviaLocalDataSourceImplemetation({required this.sharedPreferences});
